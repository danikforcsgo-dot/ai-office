...
NEWS_SOURCES = {
    ...
    "goldseek": "https://news.goldseek.com/rss.php",
}

PAIR_KEYWORDS = {
    "XAU/USD": {"required": ["GOLD", "XAU", "PRECIOUS", "BULLION", "SAFE HAVEN"], "optional": ["DOLLAR", "DXY", "FED", "INFLATION", "RATE"]},
    "XAUUSD": {"required": ["GOLD", "XAU", "CFD", "SPOT"], "optional": ["DOLLAR", "DXY", "FED"]},
    "GC=F": {"required": ["FUTURES", "COMEX", "GOLD FUTURES", "GC"], "optional": ["DOLLAR", "DXY", "FED"]},
}

GOLD_KEYWORDS = {
    "required": ["GOLD", "XAU", "BULLION", "PRECIOUS METALS", "SAFE HAVEN"],
    "optional": ["DOLLAR", "DXY", "FED", "INFLATION", "RATE", "CPI", "BOND", "YIELD"],
}
